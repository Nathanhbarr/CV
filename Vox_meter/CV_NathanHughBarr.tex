...
\cvheading{Nathan Hugh Barr \\ Dataingeniør - Fra data til indsigt. } % Large heading - your name
...
Som Cand.Scient i Fysik og Matematik har jeg god erfaring med databehandling, rapportering af data-analysen og kan arbejde på et højt tværfagligt niveau. Min analytiske tilgang, som kommer fra et stærkt matematisk fundament gør, at jeg let kan strukturere og foretage statistisk analyser på små som store datamængder. Halvdelen af min uddannelse har bestået af problemorienteret projektarbejde, hvor jeg i mange af disse projekter har arbejdet med forskellige typer af data. Udover dette har jeg også gode planlægningskompetencer og en god kritisk sans. Min uddannelse har til dels været fokuseret på numeriske beregninger, som har motiveret mig til at lære, hvordan man behandler data i python og Matlab. Efter uddannelsen har jeg brugt en del tid på at kode med sql og php, og hvordan disse spiller sammen med python. Min tutor og Science Show erfaring har givet mig kompetencer til at være i dialog med "kunden", hvor jeg fokuserer på hvad kundens behov er, og hvordan jeg bedst kan levere løsninger til kunden, der virker. Mit modersmål er engelsk, men jeg taler også flydende dansk. Jeg er en optimistisk og rar person, som leder efter udfordringer og ansvar.
}
