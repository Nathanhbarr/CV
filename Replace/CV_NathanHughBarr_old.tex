...
\cvheading{Nathan Hugh Barr \\ Programmør og Data Scientist} % Large heading - your name
...
\aboutme{\underline{\textbf{Professional Profile:}}}{
	
Jeg er Cand.Scient i Fysik og Matematik med erfaring i data behandling. Jeg har en analytisk tilgang til strukturering og behandling af data som er kommet fra en stærkt matematisk fundament. Min uddannelse har været projekt orienteret hvor jeg har arbejdet med flere forskellige data sets indenfor naturvidenskab. Jeg har også planlægningskompetence samt er kritisk over for det arbejde jeg laver. Min uddannelse har til dels været fokuseret på beregninger, som har motiveret mig til lærer hvordan man behandler data i python og Matlab. Jeg er begyndt at lære hvordan man koder med sql og php og hvordan de spiller sammen med python. Fra min tutor og Science show erfaring har jeg kompetence at være i dialog med "kunden", hvor jeg fokuserer på hvad kundens behov er og hvordan jeg bedst kan levere løsninger til kunden der virker. Mit modersmål er engelsk, så jeg kan kommunikere både på dansk og engelsk. Jeg er en optimistisk og rar person, som leder efter udfordringer og ansvar.    
